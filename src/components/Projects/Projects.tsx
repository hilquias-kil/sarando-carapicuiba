...
export const Projects = () => (
  <>
    <section className="px-6 py-12 lg:py-16 lg:w-[1024px] xl:w-[1280px] lg:m-auto md:flex md:items-start md:gap-6 lg:gap-12 ">
      <h2 className="font-bebas text-4xl md:text-6xl">Nossos Projetos</h2>
    </section>
    <section className="px-6 py-12 lg:py-16 lg:w-[1024px] xl:w-[1280px] lg:m-auto md:flex md:items-start md:gap-6 lg:gap-12 ">
      <img src="/capacitacao-profissional.webp" className="mb-4 md:w-1/2" />
      <div>
        ...
        <p className="mb-6">
          A ONG Sarando Carapicuba em parceria com a Sage oferece uma variedade
          de programas e serviços de capacitação para ajudar as pessoas a se
        ...
        <p className="mb-6">
          ...
          valorizadas pelas empresas, pois ajudam a criar um ambiente de
        ...
        <p className="mb-6">
          ...
          pessoas a se capacitar, considere se tonar um voluntário. Juntos
          podemos ajudar mais pessoas a alcançar seu potencial profissional.
        </p>
      </div>
    </section>
  </>
